...
- Current trusted topic coverage now includes concrete subtopics like `kinderzuschlag`, `bedarfsgemeinschaft`, `regelbedarf`, and `mehrbedarf`, not just the umbrella `buergergeld`
