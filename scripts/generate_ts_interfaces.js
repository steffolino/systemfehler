...
out += `  sourceTier?: string;\n`;
out += `  institutionType?: string;\n`;
out += `  jurisdiction?: string;\n`;
out += `  publishedAt?: string;\n`;
out += `  modifiedAt?: string;\n`;
...
out += `  variant?: 'einfach' | 'leicht';\n`;
out += `  reviewStatus?: 'suggested' | 'approved' | 'rejected';\n`;
out += `  reviewedBy?: string;\n`;
out += `  reviewedAt?: string;\n`;
out += `}\n\n`;
