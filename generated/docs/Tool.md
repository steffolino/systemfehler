...
URI: [https://systemfehler.dev/schema/Tool](https://systemfehler.dev/schema/Tool)
...
| ---  | ---  |
| self | https://systemfehler.dev/schema/Tool |
| native | https://systemfehler.dev/schema/Tool |
